...
public class ExplorePicturesMapActivity extends FragmentActivity implements OnMapReadyCallback {
            ...
            public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
                ...
                mMap.addMarker(new MarkerOptions().position(customMarkerLocationOne).
                        icon(BitmapDescriptorFactory.fromBitmap(
                                createCustomMarker(ExplorePicturesMapActivity.this, bitmap,eventName))));
            }
